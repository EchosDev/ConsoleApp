    ...
    public class StudentController
    {
        ...
        StudentInput:
            ...
            if (isStudentGroupId && isStudentAge && !string.IsNullOrEmpty(studentName) && !string.IsNullOrEmpty(studentSurname))
            {
                ...
                Helper.Print(ConsoleColor.Green, $"Student has been created \nStudent Info: {createdStudent}");
            }
            else
            {
        ...
        StudentIdInput:
            ...
            if (isStudentId)
            {
                ...
                Helper.Print(ConsoleColor.Green, "Student has been deleted succesfully");
            }
            else
            {
                Helper.Print(ConsoleColor.Red, "Please enter valid id type");
        ...
        public void StudentMenu()
        {
            ...
            StudentMenu:
                ...
                "5 - Get By Age, 6 - Get By GroupID, 7 - Get All,8 - Search Student By Name or Surname, 9 - Back to Main Menu");
